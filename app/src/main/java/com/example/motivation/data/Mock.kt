...
data class Phrase(val description: String, val catogoryId: Int, val lang: String)
...
class Mock {
   ...
   fun filterByCategoryId(categoryId: Int, lang: String):String{
       val listPhrasesByCategory = mListPhrase.filter { (it.catogoryId == categoryId || categoryId == all) && it.lang == lang}
       return listPhrasesByCategory[Random.nextInt(listPhrasesByCategory.size)].description
