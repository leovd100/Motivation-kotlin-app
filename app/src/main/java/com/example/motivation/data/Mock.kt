...
data class Phrase(val description: String, val catogoryId: Int)
...
class Mock {
   ...
   fun filterByCategoryId(categoryId: Int):String{
       val listPhrasesByCategory = mListPhrase.filter { it.catogoryId == categoryId || categoryId == all }
